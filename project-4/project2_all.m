...
% Crop the image
orig_im = orig_im(1:256, 251:251+256-1);
% Convert to double
...
epsilon_dct = sqrt(1.1) * patch_size(1) * sigma;
...
epsilon_learning = sqrt(1.1) * patch_size(1) * sigma;
...
%% SOS Boosting
% Strengthen-Operate-Subtract (SOS)
...
% Write your code here... 
est_learning_sos = unitary_image_denoising(...
    s_im, D_sos, T, epsilon_sos);
